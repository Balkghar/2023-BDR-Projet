...
VALUES (8, 1, 'Jardin', 'Tondeuse électrique',
        ...
        20, 'DAY', 'ACTIVE'),
       (2, 2, 'Voitures', 'Voiture de sport BMW',
        ...
        150, 'DAY', 'ACTIVE'),
       (4, 3, 'Ordinateurs', 'Ordinateur de gaming',
        ...
        40, 'WEEK', 'ACTIVE'),
       (6, 4, 'Jardin', 'Taille-haie professionnel',
        ...
        25, 'DAY', 'ACTIVE'),
       (1, 5, 'Outils', 'Perceuse à percussion',
        ...
        30, 'WEEK', 'ACTIVE'),
       (3, 6, 'Vélos', 'Vélo de montagne tout-terrain',
        ...
        15, 'DAY', 'ACTIVE'),
       (5, 7, 'Cuisine', 'Robot culinaire multifonction',
        ...
        35, 'MONTH', 'ACTIVE'),
       (7, 8, 'Jeux', 'Console de jeu PlayStation 5',
        ...
        50, 'WEEK', 'ACTIVE'),
       (8, 1, 'Homme', 'Costume élégant pour homme',
        ...
        40, 'DAY', 'ACTIVE'),
       (10, 2, 'Femme', 'Robe de soirée glamour',
        ...
        45, 'DAY', 'ACTIVE'),
       (1, 3, 'Electroménager', 'Machine à café automatique',
        ...
        25, 'WEEK', 'ACTIVE'),
       (2, 4, 'Cuisine', 'Appareil à fondue électrique',
        ...
        20, 'DAY', 'ACTIVE'),
       (3, 5, 'Vêtements', 'Ensemble de ski complet',
       ...
       (4, 6, 'Sport', 'Planche de surf',
        ...
        25, 'DAY', 'ACTIVE'),
       (5, 7, 'Electroménager', 'Robot aspirateur intelligent',
        ...
        35, 'WEEK', 'ACTIVE'),
       (6, 8, 'Loisirs', 'Appareil photo professionnel',
        ...
        40, 'WEEK', 'ACTIVE'),
       (7, 1, 'Informatique', 'Imprimante 3D',
       ...
       (8, 2, 'Musique', 'Piano numérique',
        ...
        50, 'WEEK', 'ACTIVE'),
       (10, 3, 'Maison', 'Aspirateur sans sac',
       ...
       (3, 5, 'Femme', 'Sac à main design',
        ...
        20, 'DAY', 'ACTIVE'),
       (4, 6, 'Enfant', 'Trottinette électrique',
        ...
        15, 'DAY', 'ACTIVE'),
       (5, 7, 'Loisirs', 'Enceinte Bluetooth portable',
        ...
        25, 'WEEK', 'ACTIVE'),
       (6, 8, 'Electroménager', 'Fer à repasser vapeur',
        ...
        15, 'DAY', 'ACTIVE'),
       (7, 1, 'Bricolage', 'Scie circulaire professionnelle',
        ...
        30, 'WEEK', 'ACTIVE'),
       (8, 2, 'Jardinage', 'Débroussailleuse thermique',
        ...
        40, 'DAY', 'ACTIVE'),
       (10, 3, 'Vêtements', 'Veste en cuir vintage',
        ...
        35, 'WEEK', 'ACTIVE'),
       (2, 4, 'Voitures', 'Scooter électrique',
        ...
        25, 'DAY', 'ACTIVE'),
       (3, 5, 'Sport', 'Raquettes de tennis Wilson',
        ...
        20, 'DAY', 'ACTIVE'),
       (4, 6, 'Musique', 'Guitare acoustique',
        ...
        30, 'WEEK', 'ACTIVE'),
       (9, 3, 'Loisirs', 'Tente de camping 4 personnes',
        ...
        15, 'DAY', 'ACTIVE'),
       (10, 4, 'Electroménager', 'Aspirateur sans sac',
        ...
        25, 'WEEK', 'ACTIVE'),
       (1, 5, 'Voitures', 'Véhicule utilitaire',
        ...
        40, 'DAY', 'ACTIVE'),
       (2, 6, 'Bricolage', 'Scie circulaire professionnelle',
        ...
        30, 'DAY', 'ACTIVE'),
       (3, 7, 'Sport', 'Équipement de camping complet',
        ...
        50, 'WEEK', 'ACTIVE'),
       (4, 8, 'Jeux', 'Console Xbox Series X',
        ...
        50, 'WEEK', 'ACTIVE'),
       (5, 1, 'Electroménager', 'Machine à laver haute capacité',
        ...
        35, 'WEEK', 'ACTIVE'),
       (6, 2, 'Vélos', 'Vélo électrique pliable',
        ...
        25, 'DAY', 'ACTIVE'),
       (7, 3, 'Informatique', 'Moniteur incurvé 4K',
        ...
        40, 'WEEK', 'ACTIVE'),
       (8, 4, 'Cuisine', 'Barbecue à gaz professionnel',
       ...
       (9, 5, 'Outils', 'Perforateur SDS+',
        ...
        20, 'DAY', 'ACTIVE'),
       (10, 6, 'Loisirs', 'Tente de camping familiale',
        ...
        30, 'WEEK', 'ACTIVE'),
       (1, 7, 'Electroménager', 'Robot de cuisine multifonction',
        ...
        35, 'MONTH', 'ACTIVE'),
       (2, 8, 'Informatique', 'Laptop ultrabook',
       ...
       (4, 2, 'Voitures', 'SUV spacieux',
        ...
        80, 'DAY', 'ACTIVE'),
       (5, 3, 'Bricolage', 'Perceuse visseuse sans fil',
        ...
        20, 'WEEK', 'ACTIVE'),
       (6, 4, 'Electroménager', 'Réfrigérateur américain',
        ...
        50, 'WEEK', 'ACTIVE'),
       (7, 5, 'Jeux', 'Table de ping-pong extérieure',
        ...
        30, 'DAY', 'ACTIVE'),
       (8, 6, 'Vêtements', 'Tenue de ski complète',
