...
<form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="description" name="description" rows="4" cols="50" required><?php echo ($ad['description']) ?></textarea>

    </div>
    <div class="form-group">
        <label for="lname">Prix :</label>
        <input class="form-control" value="<?php echo ($ad['price']) ?>" type="number" step="0.05" id="price" name="price" required>
    </div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" value="<?php echo ($ad['street']) ?>" type="text" id="street" name="street" required>
    </div>

    <div class="form-group">
        <label for="lname">Numéro de rue :</label>
        <input class="form-control" value="<?php echo ($ad['streetnumber']) ?>" type="text" id="streetNumber" name="streetNumber" required>
    </div>
