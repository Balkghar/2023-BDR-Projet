...
<form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
   ...
   <div class="form-group">
      ...
      <input class="form-control" value="<?php echo ($ad['price']) ?>" type="number" step="0.05" id="price" name="price">
   </div>
   ...
   <input type="hidden" id="idaddr" name="idaddr" value="<?php echo ($ad['idadrr']) ?>">
   ...
   <div class="form-group">
      ...
      <input class="form-control" value="<?php echo ($ad['streetnumber']) ?>" type="text" id="streetNumber" name="streetNumber">
   </div>
