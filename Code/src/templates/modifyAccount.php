...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" id="mail" name="mail" value="<?php echo ($user['mail']); ?>" required>
    </div>
    <div class="form-group">
        <label for="lname">Numéro de téléphone :</label>
        <input class="form-control" type="tel" id="phoneNumber" name="phoneNumber" value="<?php echo ($user['phonenumber']); ?>" required>
    </div>
    <div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" id="street" name="street" value="<?php echo ($user['street']); ?>" required>
    </div>

    <div class="form-group">
        <label for="lname">Numéro de rue :</label>
        <input class="form-control" type="text" id="street" name="streetNumber" value="<?php echo ($user['streetnumber']); ?>" required>
    </div>
